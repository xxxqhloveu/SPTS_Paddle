...
from test_util import get_logger, print_dict
# sys.path.append("/data/xiaoqihang/myproject/model/PaddleOCR")
...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-c", "--config", help="configuration file to use", \
            default="/data/xiaoqihang/myproject/SPTS_Paddle/SPTS.yml")
        self.add_argument(
...
def preprocess(is_train=False):
    ...
    # config['Global']['num_bins'] = 1000    
    # config['Global']['sos_index'] = 1098
    # config['Global']['eos_index'] = 1097
    # config['Global']['recog_pad_index'] = 1096
    # config['Global']['eos_loss_coef'] = 0.01
    # config['Global']['num_classes'] = 1100
    # config['Global']['padding_index'] = 1099
